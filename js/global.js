...
(function () {
  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    const openProjectPanel = (card, onLaunch) => {
      ...
      actions.innerHTML = ''
        + '<button type="button" class="btn btn-primary btn-sm" data-panel-launch><i class="fas fa-code"></i> Source Code</button>'
    ...
    if (contactForm) {
      contactForm.addEventListener('submit', async (e) => {
        ...
        if (IS_GITHUB_PAGES) {
          ...
          showToast('Opening Gmail compose...', 'success', 2500);
          return;
        }
